...
class FormatModel(FormattedTableModel, FormatterMixIn):
    ...
    def format_two_decimals(ser: pd.Series) -> pd.Series:
        ...
        return ser.apply(format_two_decimals)
...
@pytest.fixture(scope="module")
def data_col_numbers(simple_df) -> Dict[str, int]:
...
class TestBaseTableModel:
    ...
    def test_data_non_display_role(self, base_table):
    ...
    def test_table_dimensions(self, base_table, simple_df):
    ...
    def test_header(self, base_table, simple_df):
    ...
    def test_sort(self, base_table, data_col_numbers):
...
class TestFormattedTableModel:
    ...
    @pytest.fixture
    def missing_meta_col(self, meta_df) -> pd.DataFrame:
        """ Return a meta table with a missing column """
        return meta_df[["visible", "display_format"]]

    @pytest.fixture
    def missing_meta_val(self, meta_df) -> pd.DataFrame:
    ...
    @pytest.fixture
    def extra_data_col(self, simple_df) -> pd.DataFrame:
    ...
    def test_visible(self, format_table, simple_df):
        """
    ...
    def test_formatting(self, format_table):
...
class TestEditableTableModel:
    ...
    @pytest.fixture(scope="class")
    def editable_col_numbers(self, editable_meta) -> pd.Series:
    ...
    @pytest.fixture(scope="function")
    def edit_table(self, editable_table, editable_col_numbers) -> EditableTableModel:
    ...
    def test_displayed_table_edits(self, edit_table):
    ...
    def test_data_table_edits(self, edit_table):
    ...
    def test_unedited(self, edit_table):
    ...
    def test_get_modified_data(self, edit_table):
    ...
    def test_empty_modified_data_cache(self, edit_table):
